...
for svmf in SVM_folds:
    ...
    ax.plot(n_components, f1[svmf], "o-", label="F1 Score",
            linewidth=2.0)
    ...
    plt.title("Method 3 Blind Experiments. SVM Folds: %d" % svmf)
...
for svmf in SVM_folds:
    ...
    ax.grid()
    plt.xlabel('Number of States')
    plt.title("Method 3 Semi-Blind Experiments. SVM Folds: %d" % svmf)
...
for svmf in SVM_folds:
    ...
    plt.plot(n_components,
             specificity_3[svmf][n_components[0]:n_components[-1] + 1],
             label="Specificity", linewidth=2.0)
    plt.plot(n_components, f1_3[svmf], "o-", label="F1 Score",
             linewidth=2.0)
    ...
    ax.grid()
    plt.xlabel('Number of States')
    plt.title("Method 3 Blind Experiments 3 Follow-Ups. SVM Folds: %d" % svmf)
...
for svmf in SVM_folds:
    ...
    ax.grid()
    plt.xlabel('Number of States')
    plt.title("Method 3 Semi-Blind Experiments 3 Follow-Ups. SVM Folds: %d" % svmf)
