...
plt.title("Method 2 Blind Experiments")
...
for svmf in SVM_folds:
    ...
    ax.plot(n_components,
            ...
            color=colors1[idx])
    idx += 1
    ax.plot(n_components, f1_CV[svmf], "o-", label="F1 Score, %d Folds" % svmf,
            linewidth=2.0, color=colors1[idx])
    idx += 1
...
ax.grid()
plt.xlabel('Number of States')
plt.title("Method 2 Semi-Blind Experimentss")
...
ax.grid()
plt.xlabel('Number of States')
plt.title("Method 2 Blind Experiments 3 Follow-Ups")
...
ax.grid()
plt.xlabel('Number of States')
plt.title("Method 2 Semi-Blind Experiments 3 Follow-Ups")
