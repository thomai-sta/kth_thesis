...
for svmf in SVM_folds:
    ...
    ax.plot(n_components, f1[svmf], "o-", label="F1 Score", linewidth=2.0)
    ...
    plt.title("Method 2 Blind Experiments. SVM Folds: %d" % svmf)
...
for svmf in SVM_folds:
    ...
    ax.plot(n_components,
            specificity_CV[svmf][n_components[0]:n_components[-1] + 1],
            label="Specificity", linewidth=2.0)
    ax.plot(n_components, f1_CV[svmf], "o-", label="F1 Score", linewidth=2.0)
    ...
    ax.grid()
    plt.xlabel('Number of States')
    plt.title("Method 2 Semi-Blind Experiments. SVM Folds: %d" % svmf)
...
for svmf in SVM_folds:
    ...
    ax.plot(n_components, f1_3[svmf], "o-", label="F1 Score, %d Folds" % svmf,
            linewidth=2.0)
    ...
    ax.grid()
    plt.xlabel('Number of States')
    plt.title("Method 2 Blind Experiments 3 Follow-Ups. SVM Folds: %d" % svmf)
...
for svmf in SVM_folds:
    ...
    ax.plot(n_components,
            specificity_3_CV[svmf][n_components[0]:n_components[-1] + 1],
            label="Specificity, %d Folds" % svmf, linewidth=2.0)
    ax.plot(n_components, f1_CV_3[svmf], "o-",
    ...
    ax.grid()
    plt.xlabel('Number of States')
    plt.title("Method 2 Semi-Blind Experiments 3 Follow-Ups. SVM Folds: %d" % svmf)
...
#     idx += 1
#     plt.plot(n_components, dor_3[svmf],
#              label="DOR Blind 3 FU", linewidth=2.0, color=colors2[idx])
#     idx += 1
#     plt.plot(n_components, dor_CV[svmf],
#              label="DOR Semi-Blind", linewidth=2.0, color=colors2[idx])
#     idx += 1
#     plt.plot(n_components, dor_CV_3[svmf],
#              label="DOR with Semi-Blind 3 FU", linewidth=2.0,
#              color=colors2[idx])
#     plt.legend(loc=0)
#     plt.grid()
#     plt.xlabel('Number of States')
#     plt.title("Method 2 Diagnostic odds ratio, Folds: %d" % svmf)
